    ...
    <div className="container mx-auto px-4 py-8 space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="space-y-2">
          ...
          <p className="text-lg text-muted-foreground">Films, séries et épisodes à venir</p>
        </div>

        <div className="flex items-center gap-4">
          <div className="flex items-center space-x-2 bg-gradient-to-r from-purple-100 to-blue-100 p-3 rounded-lg border border-purple-200">
            <Switch id="favorites-only" checked={showOnlyFavorites} onCheckedChange={setShowOnlyFavorites} />
            <Label htmlFor="favorites-only" className="font-medium text-purple-800">
              Favoris uniquement
            </Label>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Calendrier */}
        <Card className="lg:col-span-2 bg-gradient-to-br from-blue-50 to-purple-50 border-blue-200 shadow-xl">
              ...
              <div className="space-y-4 max-h-96 overflow-y-auto">
                {events.slice(0, 50).map((event) => (
                  <button
                    key={`${event.type}-${event.id}`}
                    onClick={(e) => handleEventClick(event, e)}
                    className="w-full flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-50 transition-colors group text-left"
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {event.isFavorite && <Star className="w-4 h-4 text-yellow-500 fill-current" />}
                      </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    {selectedEvent.vote_average && selectedEvent.vote_average > 0 && (
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-sm font-medium">{selectedEvent.vote_average.toFixed(1)}</span>
                      </div>
                    )}
        ...
        <CardContent className="pt-6">
          <div className="flex flex-wrap gap-6 text-sm">
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 bg-gradient-to-r from-red-400 to-red-600 border border-red-300 rounded shadow-sm"></div>
              <span className="font-medium text-red-700">Films</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 bg-gradient-to-r from-blue-400 to-blue-600 border border-blue-300 rounded shadow-sm"></div>
              <span className="font-medium text-blue-700">Séries TV</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 bg-gradient-to-r from-green-400 to-green-600 border border-green-300 rounded shadow-sm"></div>
              <span className="font-medium text-green-700">Épisodes</span>
            </div>
            <div className="flex items-center gap-2">
              <Star className="w-5 h-5 text-yellow-500 fill-current drop-shadow-sm" />
              <span className="font-medium text-yellow-700">Favori</span>
            </div>
          </div>
        </CardContent>
      </Card>
