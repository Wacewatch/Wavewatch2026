            ...
            <div className="space-y-6">
              <div className="flex justify-between items-start">
                <div className="space-y-2">
                  ...
                  <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">{episodeName}</h1>
                  {showData?.name && (
                    <Link href={showUrl} className="text-xl text-blue-400 hover:text-blue-300">
                      {showData.name}
                    </Link>
                  )}
                </div>
              ...
              <p className="text-lg md:text-xl text-gray-200 leading-relaxed">{episodeOverview}</p>
