...
function RealisticAvatar({ position, avatarStyle, isMoving }: RealisticAvatarProps) {
...
export default memo(RealisticAvatar, (prev, next) => {
  return (
    prev.position[0] === next.position[0] &&
    prev.position[1] === next.position[1] &&
    prev.position[2] === next.position[2] &&
    prev.isMoving === next.isMoving &&
    prev.avatarStyle?.bodyColor === next.avatarStyle?.bodyColor &&
    prev.avatarStyle?.skinTone === next.avatarStyle?.skinTone &&
    prev.avatarStyle?.hairStyle === next.avatarStyle?.hairStyle &&
    prev.avatarStyle?.hairColor === next.avatarStyle?.hairColor &&
    prev.avatarStyle?.accessory === next.avatarStyle?.accessory &&
    prev.avatarStyle?.faceSmiley === next.avatarStyle?.faceSmiley
  )
})
