        ...
        <Tabs defaultValue="settings" className="space-y-6">
          <div className="overflow-x-auto -mx-4 px-4 pb-2">
            <TabsList className="inline-flex w-auto min-w-full bg-gray-800 border-gray-700 flex-nowrap">
              <TabsTrigger value="settings" className="flex items-center justify-center gap-1 data-[state=active]:bg-gray-700 text-gray-300 text-xs sm:text-sm px-2 sm:px-3 whitespace-nowrap">
                <Globe className="w-4 h-4" />
                <span className="hidden sm:inline">Paramètres du Monde</span>
                <span className="sm:hidden">Monde</span>
              </TabsTrigger>
              <TabsTrigger value="cinema" className="flex items-center justify-center gap-1 data-[state=active]:bg-gray-700 text-gray-300 text-xs sm:text-sm px-2 sm:px-3 whitespace-nowrap">
                <Film className="w-4 h-4" />
                <span className="hidden sm:inline">Salles de Cinéma</span>
                <span className="sm:hidden">Cinéma</span>
              </TabsTrigger>
              <TabsTrigger value="customization" className="flex items-center justify-center gap-1 data-[state=active]:bg-gray-700 text-gray-300 text-xs sm:text-sm px-2 sm:px-3 whitespace-nowrap">
                <Palette className="w-4 h-4" />
                <span className="hidden sm:inline">Personnalisation</span>
                <span className="sm:hidden">Avatars</span>
              </TabsTrigger>
              <TabsTrigger value="users" className="flex items-center justify-center gap-1 data-[state=active]:bg-gray-700 text-gray-300 text-xs sm:text-sm px-2 sm:px-3 whitespace-nowrap">
                <Users className="w-4 h-4" />
                <span className="hidden sm:inline">Utilisateurs En Ligne</span>
                <span className="sm:hidden">En Ligne</span>
              </TabsTrigger>
              <TabsTrigger value="arcade" className="flex items-center justify-center gap-1 data-[state=active]:bg-gray-700 text-gray-300 text-xs sm:text-sm px-2 sm:px-3 whitespace-nowrap">
                <Gamepad2 className="w-4 h-4" />
                <span className="hidden sm:inline">Jeux Arcade</span>
                <span className="sm:hidden">Arcade</span>
              </TabsTrigger>
              <TabsTrigger value="stadium" className="flex items-center justify-center gap-1 data-[state=active]:bg-gray-700 text-gray-300 text-xs sm:text-sm px-2 sm:px-3 whitespace-nowrap">
                <Trophy className="w-4 h-4" />
                <span className="hidden sm:inline">Stade</span>
                <span className="sm:hidden">Stade</span>
              </TabsTrigger>
              <TabsTrigger value="disco" className="flex items-center justify-center gap-1 data-[state=active]:bg-gray-700 text-gray-300 text-xs sm:text-sm px-2 sm:px-3 whitespace-nowrap">
